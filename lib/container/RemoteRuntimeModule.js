...
class RemoteRuntimeModule extends RuntimeModule {
	...
	generate() {
		...
		return Template.asString([
			...
			Template.indent([
				`chunkMapping: ${JSON.stringify(chunkToRemotesMapping, null, "\t")},`,
				`moduleIdToRemoteDataMapping: ${JSON.stringify(
			...
			`${
				...
				`var chunkMapping = ${RuntimeGlobals.require}.remotesLoadingData.chunkMapping;`,
				`var moduleIdToRemoteDataMapping = ${RuntimeGlobals.require}.remotesLoadingData.moduleIdToRemoteDataMapping;`,
